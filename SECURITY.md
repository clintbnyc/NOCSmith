...
services, and `SnapshotService.cs`.
...
secret-name and inline-pattern redaction, bounded history/group/log reads,
validated counts and pagination, per-section snapshot failure, explicit
source/authority metadata, and separation of current, historical, and
group-membership grains.
